...
COMMAND_TO_SCRIPT = {
    ...
    "build-kb": REPO_ROOT / "scripts" / "build_local_kb.py",
    ...
    "fetch-its-standards": REPO_ROOT / "scripts" / "fetch_its_v8std.py",
}

COMMAND_DESCRIPTIONS = {
    "benchmark": "measure query latency for built packs",
    "bootstrap": "install local Python dependencies for the toolkit",
    "build-kb": "build local compact KB packs (help, metadata, standards)",
    ...
    "fetch-its-standards": "fetch ITS v8std standards into local markdown files (ITS-only)",
    ...
    "query-kb": "query platform, metadata, or standards knowledge packs",
